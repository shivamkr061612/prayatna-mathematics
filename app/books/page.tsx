    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans selection:bg-indigo-100 selection:text-indigo-900">
        ...
        <div className="bg-white border-b border-slate-200 py-6 sm:py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="flex items-center gap-2 text-xs font-medium text-slate-500 mb-3" aria-label="Breadcrumb">
              ...
              <span className="text-indigo-700 font-semibold">Books & Material</span>
            </nav>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                  Study Material & Book Library
                </h1>
                <p className="mt-1 text-xs sm:text-sm text-slate-600 max-w-2xl">
                  Official NCERT textbooks, Exemplar step-wise solutions, JEE Advanced reference guides, and curated coaching theory notes.
                </p>
              </div>
      ...
      <footer className="border-t border-slate-200 bg-white py-8 mb-16 md:mb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-xs text-slate-500">
          © {new Date().getFullYear()} Prayatna Mathematics. Educational textbooks and reference material for enrolled students.
        </div>
      </footer>
